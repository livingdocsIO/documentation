...
* `status`, one of the supported [statuses](print-api.md#available-statuses)
...
![Choose a print layout in Livingdocs](https://github.com/livingdocsIO/livingdocs/tree/29994840d3de4e9fc999395c30686a388b7da9bb/reference-docs/server-api/images/print-layout.png)
...
![Choose a print template in Livingdocs](https://github.com/livingdocsIO/livingdocs/tree/29994840d3de4e9fc999395c30686a388b7da9bb/reference-docs/server-api/images/print-template.png)
...
![Print Preview for a component that is not in the layout](https://github.com/livingdocsIO/livingdocs/tree/29994840d3de4e9fc999395c30686a388b7da9bb/reference-docs/server-api/images/print-preview-inexisting-component.png)
...
![The Livingdocs print preview](https://github.com/livingdocsIO/livingdocs/tree/29994840d3de4e9fc999395c30686a388b7da9bb/reference-docs/server-api/images/print-preview.png)
...
![The print department selection in the user interface](https://github.com/livingdocsIO/livingdocs/tree/29994840d3de4e9fc999395c30686a388b7da9bb/reference-docs/server-api/images/print-metadata-department.png)
...
* information about the print article, in particular:
  ...
  * `status`, the status of this article, [see available statuses](print-api.md#available-statuses)
...
The main content is in the `articleExportData` block. It contains the content in components of the Livingdocs print design, e.g. the `title` and the `text`. Aside of the component-based export, there is also an `html` field where the whole document is rendered as HTML.
