...
- [v231.0.34](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v231.0.34): fix(security): Update `get-func-name` to version `v231.0.38` to patch CVE-2023-43646
...
- [v231.0.32](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v231.0.32): fix(security): Update `sharp` to version `v231.0.38` to patch CVE-2023-4863
