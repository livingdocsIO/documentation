...
To get an overview about new functionality, read the [Release Notes](https://livingdocs.io/en/blog/release-march-2026).
...
- [Feature Webinar Recording](https://us02web.zoom.us/rec/share/nrSoUutWO88VG_VqR2RLQk2pMe4CT-9_kzRSd6osEyjDXlSArpx2N8Ab6WZdZEfH.VWRgI5zM2JRpsKwr) | Passcode: `$eNi^5B@`
- [Feature Webinar Slides](https://drive.google.com/file/d/1OInvT3uLj5cIgKctZ8mNmEjbrLuVYDYe/view?usp=sharing)
- [Developer Webinar Recording](https://us02web.zoom.us/rec/share/ml5msPWlGXXtTx2llfk4-KmP9OuFBQO7Jqfp1tN4PleUOJY_s83zSOTYVUmbfSDR.iBVpet-oRs42V5Tv) | Passcode: `3$aJ&ztx`
...
- [v296.2.56](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v296.2.56): fix(deps): update dependency @livingdocs/framework from 32.12.13 to v32.12.14
- [v296.2.55](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v296.2.55): fix(deps): automatically patch Node.js vulnerabilities
- [v296.2.54](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v296.2.54): fix(deps): automatically patch Node.js vulnerabilities
- [v296.2.53](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v296.2.53): fix(deprecations): Don't define breaking change date for 3 deprecations
- [v296.2.52](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v296.2.52): fix(includes): speed up regression test
- [v296.2.51](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v296.2.51): fix(deps): update dependency @livingdocs/framework from 32.12.12 to v32.12.13
...
- [v296.2.43](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v296.2.43): fix(blob-store): prevent S3 socket exhaustion on partial image reads
- [v296.2.42](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v296.2.42): fix(deps): update dependency nodemailer from 8.0.5 to 9.0.1 [security]
...
- [v296.2.30](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v296.2.30): fix(deps): update dependency @livingdocs/framework from 32.12.9 to v32.12.10
- [v296.2.29](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v296.2.29): fix(deps): automatically patch Node.js vulnerabilities
...
- [v296.2.24](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v296.2.24): fix: Support quality, lossless and nearLossless options for webp images
...
- [v123.10.75](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.10.75): fix(webpack): Prevent dart-sass BOM from breaking scoped styles
- [v123.10.74](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.10.74): fix(properties): correct German word order in char-limit labels
...
- [v123.10.57](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.10.57): fix(media-library): Prevent li-metadata-translations save on open
...
- [v123.10.37](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.10.37): fix(deps): update dependency @livingdocs/framework from 32.12.8 to v32.12.9
- [v123.10.36](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.10.36): fix(deps): automatically patch Node.js vulnerabilities
- [v123.10.35](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.10.35): fix(deps): update dependency axios from 1.13.5 to 1.15.0 [security]
- [v123.10.34](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.10.34): fix(ld panel title): Collapse indicator position
...
- [v123.10.26](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.10.26): fix(editor): Remove unused scrollPosition property
