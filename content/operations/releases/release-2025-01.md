...
To get an overview about new functionality, read the [Release Notes](https://livingdocs.io/en/blog/release-january-2025).
...
- [v267.1.41](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v267.1.41): fix(deps): update dependency form-data from 4.0.1 to 4.0.4 [security]
...
- [v267.1.36](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v267.1.36): fix: Add parameters concurrency and batchSize to change-design-name-and-version-to-latest-project-design CLI
...
- [v267.1.31](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v267.1.31): fix(db): Fix scheduled components by taking over li_jsonb_patch of main branch (removing properties that don't exist won't throw with that)
...
- [v114.13.66](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v114.13.66): fix(ticker): Prevent component blur when clicking on component area
- [v114.13.65](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v114.13.65): fix(login): Show login errors correctly. Do not prune the hash part if it doesn't include a token parameter
- [v114.13.64](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v114.13.64): fix(core): Replace app when registering project settings components
- [v114.13.63](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v114.13.63): fix(drag-drop): Clear up markers after dragend event
