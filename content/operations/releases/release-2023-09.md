...
- [v237.2.17](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v237.2.17): fix(security): Update `get-func-name` to version `v237.2.26` to patch CVE-2023-43646
...
- [v237.2.15](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v237.2.15): fix(security): Update `sharp` to version `v237.2.26` to patch CVE-2023-4863
...
- [v100.8.60](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v100.8.60): fix(security): Update `get-func-name` to version `v100.8.68` to patch CVE-2023-43646
