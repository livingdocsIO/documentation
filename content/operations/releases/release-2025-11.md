...
- [Feature Webinar Recording](https://us02web.zoom.us/rec/share/YLC629NDl-xdSPj6FhuJPlsUF9KPBRfS4kmYdI9TLUEjMNn4I9pfymp0TIzVXeDM.XW4hauqfcoywOfOw) | Passcode: `m1jF7ii&`
- [Feature Webinar Slides](https://drive.google.com/file/d/1Wf86KFbEjL6yBpfGi7yrDJGwN1mgwdTi/view?usp=sharing)
- [Developer Webinar Recording](https://us02web.zoom.us/rec/share/74_pcrQFHPUaN9PmXEDeaprYC-rOoeWWE50TYkK4OEMzdjylX4tkqGU20F2tUtWw.7UNpm9vk008-7arn) | Passcode: `vfF@+#02`
- [Developer Webinar Slides](https://drive.google.com/file/d/1bG-p-eYahW66iXsHX45_PgUi22B8HoUc/view)
...
- [v284.0.28](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v284.0.28): fix(deps): update dependency @livingdocs/framework from 32.10.5 to v32.10.6
- [v284.0.27](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v284.0.27): fix(hugo): support extracting title from imported picture
- [v284.0.26](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v284.0.26): fix(migrations): support old documents without the statistics property
- [v284.0.25](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v284.0.25): fix(deps): update dependency axios from 1.13.2 to 1.13.5 [security]
- [v284.0.24](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v284.0.24): fix: bump file-type version for a bug fix
- [v284.0.23](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v284.0.23): fix: read mimetype from asset object
- [v284.0.22](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v284.0.22): fix(deps): update dependency @livingdocs/framework from 32.10.4 to v32.10.5
...
- [v121.3.37](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v121.3.37): fix(tasks): Sort completed tasks by completed date
- [v121.3.36](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v121.3.36): fix(task-boards): take total results from request
- [v121.3.35](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v121.3.35): fix(search): Limit query length and display understandable error
