...
To get an overview about new functionality, read the [Release Notes](https://livingdocs.io/en/blog/release-july-2026).
...
- [v308.1.30](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v308.1.30): fix: Use correct warning type for all breaking changes
- [v308.1.29](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v308.1.29): fix(deps): automatically patch Node.js vulnerabilities
- [v308.1.28](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v308.1.28): fix(deps): update dependency nodemailer from 9.0.3 to 9.1.1 [security]
...
- [v308.1.13](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v308.1.13): fix(indexing): Avoid caching empty media-library locale fields at startup
- [v308.1.12](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v308.1.12): fix(elasticsearch): Fix index behavior with translated fields
- [v308.1.11](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v308.1.11): fix(deps): automatically patch Node.js vulnerabilities
...
- [v126.1.25](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v126.1.25): fix(media-library): keep the search query when switching panel tabs
