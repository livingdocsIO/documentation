...
To get an overview about new functionality, read the [Release Notes](https://livingdocs.io/en/blog/release-march-2024).
...
They got migrated to `mediaLibrary.images`, `mediaLibrary.files` and `mediaLibrary.videos`, but backwards compatibility was in place for a long time. Please move the properties if you see errors. You can find the documentation at [Media Library]({{< ref "customising/server-configuration/#media-library" >}}).
...
- [v110.1.100](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v110.1.100): fix(security): Patch security vulnerabilities CVE-2024-4067 in `micromatch` and CVE-2024-42459 in `elliptic`
