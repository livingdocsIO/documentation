...
To get an overview about new functionality, read the [Release Notes](https://livingdocs.io/en/blog/release-may-2024).
...
* [CVE-2024-4067](https://nvd.nist.gov/vuln/detail/CVE-2024-4067) patched in `micromatch` v4.0.8s
* [CVE-2024-4068](https://github.com/advisories/GHSA-grv7-fg5c-xmjg) patched in `braces` v3.0.3
...
- [v110.13.82](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v110.13.82): fix: hide display filters on media board with external sources
- [v110.13.81](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v110.13.81): fix(user-avatar): icon size
- [v110.13.80](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v110.13.80): fix(menu-item): increase max length
- [v110.13.79](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v110.13.79): fix(security): Patch security vulnerabilities CVE-2024-45296 in `path-to-regexp`, CVE-2024-45590 in `body-parser` and CVE-2024-45813 in `find-my-way`
- [v110.13.78](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v110.13.78): fix(includes): Do not mutate intitialContent object
...
- [v110.13.73](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v110.13.73): chore(admin-dashboard): Load all users, also archived ones, so we can filter in memory
- [v110.13.72](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v110.13.72): fix(editor): Add missing publish route
- [v110.13.71](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v110.13.71): fix(security): Patch security vulnerabilities CVE-2024-4067 in `micromatch` and CVE-2024-42459 in `elliptic`
- [v110.13.70](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v110.13.70): fix(deps): update dependency webpack from 5.91.0 to 5.94.0 [security]
