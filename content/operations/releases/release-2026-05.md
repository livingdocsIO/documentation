...
To get an overview about new functionality, read the [Release Notes](https://livingdocs.io/en/blog/release-may-2026).
...
- [v301.1.39](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v301.1.39): fix(media-library): rethrow postgres errors from addEntries inside a transaction
...
- [v301.1.31](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v301.1.31): fix(deps): automatically patch Node.js vulnerabilities
...
- [v123.21.41](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.21.41): fix(publish): align content feedback title with redesigned panels
- [v123.21.40](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.21.40): fix(deps): update dependency @fastify/static from 9.1.3 to 10.1.2 [security]
...
- [v123.21.32](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.21.32): fix: keep drag scroll working after window resize
- [v123.21.31](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.21.31): fix(metadata): initialize named crops once the image is available
- [v123.21.30](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.21.30): fix(deps): bump undici to 7.28.0 and form-data to 4.0.6
