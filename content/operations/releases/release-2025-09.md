...
To get an overview about new functionality, read the [Release Notes](https://livingdocs.io/en/blog/release-september-2025).
...
- [v281.3.42](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v281.3.42): fix(hugo): support extracting title from imported picture
...
- [v119.14.51](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v119.14.51): refactor(include): reduce complexity of the debouncing bursts
