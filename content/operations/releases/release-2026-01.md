...
- [v294.0.39](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v294.0.39): fix(deps): update dependency @livingdocs/framework from 32.11.11 to v32.11.12
...
- [v294.0.23](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v294.0.23): fix(deps): automatically patch Node.js vulnerabilities
...
- [v294.0.18](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v294.0.18): fix: do not expose maxDimension if use2025Behavior is enabled
- [v294.0.17](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v294.0.17): fix(deps): update dependency file-type from 21.3.0 to 21.3.2 [security]
...
- [v123.3.63](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.3.63): fix(deps): update dependency axios from 1.16.0 to 1.18.0 [security]
- [v123.3.62](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.3.62): fix(deps): update dependency @livingdocs/framework from 32.11.11 to v32.11.12
...
- [v123.3.49](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.3.49): fix(media-library): actionbar positioning when closing sidepanel
...
- [v123.3.26](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v123.3.26): fix(metadata): Reset additional language after translation deletion
