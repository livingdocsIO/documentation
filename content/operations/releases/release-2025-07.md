...
To get an overview about new functionality, read the [Release Notes](https://livingdocs.io/en/blog/release-july-2025).
...
- [v280.1.45](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v280.1.45): fix(images): Allow gif uploads with 1800 frames
...
- [v119.3.53](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v119.3.53): fix(deps): update dependency fastify from 5.7.3 to 5.8.1 [security]
- [v119.3.52](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v119.3.52): fix(images): Allow gif uploads with 1800 frames
- [v119.3.51](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v119.3.51): fix(deps): update dependency @livingdocs/framework from 32.8.11 to v32.8.12
