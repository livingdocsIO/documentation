...
## PRs to Categorize
- [Bump minor version for release management](https://github.com/livingdocsIO/livingdocs-server/pull/8147)
- [Bump minor version for release management](https://github.com/livingdocsIO/livingdocs-editor/pull/10100)
...
- [fix(deps): update dependency cloudinary from 2.6.1 to v2.7.0 (main) - autoclosed](https://github.com/livingdocsIO/livingdocs-server/pull/8123)
...
- [fix(deps): update dependency exifreader from 4.31.0 to v4.31.1 (main)](https://github.com/livingdocsIO/livingdocs-server/pull/8118)
- [fix(deps): update aws-sdk from 3.828.0 to v3.830.0 (main) (minor)](https://github.com/livingdocsIO/livingdocs-server/pull/8114)
