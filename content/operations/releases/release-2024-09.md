...
To get an overview about new functionality, read the [Release Notes](https://livingdocs.io/en/blog/release-september-2024).
...
* [CVE-2024-21538](https://github.com/advisories/GHSA-3xgq-45jj-v275) patched in `cross-spawn` v7.0.6
...
* [CVE-2024-47764](https://nvd.nist.gov/vuln/detail/CVE-2024-47764) patched in `cookie` v0.7.0
* [CVE-2024-48948](https://github.com/advisories/GHSA-fc9h-whq2-v747) patched in `elliptic` v6.6.0
...
- [v257.0.31](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v257.0.31): chore(references): Update `manual-migrations/006-generate-references.js` to skip revision updates when there are no references on them and remove unnecessary transactions
- [v257.0.30](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v257.0.30): fix(upload): Forward image upload errors to the destination after wrapping upload streams with `limitStreamSize`
...
- [v257.0.20](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v257.0.20): fix(deps): update dependency @livingdocs/framework from 29.5.9 to v29.5.10
...
- [v110.34.69](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v110.34.69): fix(deps): update dependency nanoid [security]
...
- [v110.34.47](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v110.34.47): fix(li-toolbar): avoid language label to overlap title
...
- [v110.34.42](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v110.34.42): fix: Revert connecting local clipboard state to canvas clipboard state
- [v110.34.41](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v110.34.41): fix(multiselect): add missing translations
- [v110.34.40](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v110.34.40): fix(multilist-editor): Fix realtime updates for inbox
