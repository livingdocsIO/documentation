...
{{< img src="images/architecture-editing.png" alt="Editorial users pass through separate load balancers to redundant Editor and editing server instances, with the servers connecting to Elasticsearch, Postgres and Redis" >}}
...
{{< img src="images/architecture-delivery.png" alt="End users reach DNS-load-balanced Varnish caches that forward to load-balanced delivery apps and delivery servers, which read from Postgres, Redis and Elasticsearch" >}}
