...
If both the Livingdocs spellcheck component and the surrounded text component (e.g. a [link directive]({{< ref "/reference/document/content/directives-models#link" >}})) use the same technique, then only one line will be visible.
