...
Adding to the publication index only makes sense if you want to filter by it (so the catchline is a poor example for this). [Read about the publication index]({{< ref "/guides/elasticsearch-indexing/publication-index.md" >}})
