...
(Note: There are more modern ways of configuring includes for [articles]({{< ref "/guides/includes/article-teasers" >}}) and [lists]({{< ref "/guides/includes/article-list-teasers" >}}), which avoid the need to create custom UI components and to query for documents within the render function.)
...
The above code snippet assumes you are inside a custom feature. See [here]({{< ref "/guides/add-customizations#server" >}}) for how to register a custom feature.
...
The above code snippet again assumes you are inside a custom feature. See [here]({{< ref "/guides/add-customizations#server" >}}) for how to register a custom feature.
