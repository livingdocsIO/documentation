...
In the configuration you might find `scope` settings in some places, e.g. for the [sidePanelItems]({{< ref "/reference-docs/editor-extensions/editor-config-examples/menu-and-dashboards.md#menu-items" >}}).
