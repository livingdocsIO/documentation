...
description: Learn how to setup SSO with the example of github.
weight: 2
---
...
On the login screen of the Livingdocs editor you want a way to actually use your third-party SSO login. You can configure it like this in the [editor configuration]({{< ref "/reference-docs/editor-extensions/editor-configuration" >}}):
```
auth: {
  providers: [{
    id: 'github',
...
The first thing you need to do is to create a new custom feature in your server. See [here]({{< ref "/guides/setup/server-customization" >}}) on how this works.
