...
1. We have written a guide below on how to go through these steps. This process can be long. If you cannot complete it, we recommend using simple embeds (instead of oembeds) for Meta.
