...
For details have a look at the [server configuration reference documentation]({{< ref "/enterprise/reference-docs/server-api/metadata.md" >}})
...
Adding to the publication index only makes sense if you want to filter by it (so the catchline is a poor example for this). [Read about the publication index]({{< ref "/enterprise/guides/elasticsearch-indexing/publication-index.md" >}})
