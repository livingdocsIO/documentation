---
title: Push notifications with custom dashboard item
menus:
  guides:
    parent: Workflows
...
1. setup the firebase config in your [server configuration]({{< ref "/enterprise/reference-docs/server-configuration/_index.md#push-notifications" >}}), you will need to create a Google firebase key for this
2. in every channel that should support push notifications, [configure the required metadata field]({{< ref "/enterprise/reference-docs/project-config/content-types.md#push-notifications" >}})
3. in every channel that should support push notifications, [configure your topics]({{< ref "/enterprise/reference-docs/project-config/content-types.md#push-notifications" >}})
...
1. [whitelist the push notification metadata for use in the dashboard]({{< ref "/enterprise/reference-docs/server-configuration/_index.md#search" >}})
2. create an angular component for the dashboard item
3. [configure the angular component in the editor]({{<ref "/enterprise/reference-docs/editor-configuration/editing-features.md#dashboard" >}})
