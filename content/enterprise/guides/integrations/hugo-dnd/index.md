...
in the [server configuration]({{< ref "/enterprise/reference-docs/server-configuration/_index.md" >}})
...
See [Image Source Policy]({{< ref "/enterprise/reference-docs/editor-configuration/image-source-policy.md" >}})
...
A transformation is a single function that is expected to return an object containing a [`livingdoc`]({{< ref "/enterprise/reference-docs/content-model/livingdocs-api.md" >}}) and [`metadata`]({{< ref "/enterprise/reference-docs/server-api/metadata.md" >}}) and should have following signature:
