...
The above code snippet assumes you are inside a custom feature. See [here]({{< ref "/enterprise/guides/add-customizations#server" >}}) for how to register a custom feature.
