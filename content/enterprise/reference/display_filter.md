...
- `language`: uses the project configuration for [available languages]({{< ref "/enterprise/reference-docs/project-config/settings.md" >}}) to offer a select box to filter for languages (requires multi-language feature to be enabled)
...
One can also register it's own display filter. Look into this [guide]({{< ref "/enterprise/guides/register-custom-dashboard-filters" >}}) for more information.
