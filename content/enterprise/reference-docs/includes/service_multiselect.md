...
In order to have the same look across all services, all registered [service renderers]({{< ref "./server_customization.md" >}}) on the server must render into the same HTML template.
