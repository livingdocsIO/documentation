...
With `release-2021-03` the `displayFilters` for the Media Library Dashboards are defined on the [Media Type]({{< ref "/enterprise/reference-docs/project-config/media_types.md" >}}).
...
With `release-2021-03` the `baseFilters` for the Media Library Dashboards are defined on the [Media Type]({{< ref "/enterprise/reference-docs/project-config/media_types.md" >}}).
...
See [Media Type]({{< ref "/enterprise/reference-docs/project-config/media_types.md" >}}) documentation for more information.
