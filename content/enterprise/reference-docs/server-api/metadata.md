...
To find out more about metadata on the editor you can read the [editor documentation]({{< ref "/enterprise/reference-docs/editor-configuration/metadata" >}}) or study [examples]({{< ref "/enterprise/guides/metadata-examples" >}}).
