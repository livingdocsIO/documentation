...
Please consult the [detailed instructions]({{< ref "/enterprise/reference-docs/server-configuration/storage/google-cloud-storage" >}}) to retrieve the `credentials` from google.
