...
- One can use [Core DisplayFilter]({{< ref "/reference/display_filter.md" >}}) or [Custom DisplayFilter]({{< ref "/guides/register-custom-dashboard-filters" >}}).
...
- `displayFilters`
  ...
  The filters that are shown to the user. One can use [Core DisplayFilter]({{< ref "/reference/display_filter.md" >}}) or [Custom DisplayFilter]({{< ref "/guides/register-custom-dashboard-filters" >}}).
