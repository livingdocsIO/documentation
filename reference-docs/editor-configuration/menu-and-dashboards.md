...
- `language`: uses the channel configuration for [available languages](../channel-config/README.md) to offer a select box to filter for languages (requires multi-language feature to be enabled)
