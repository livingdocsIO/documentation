...
- One can use [Core DisplayFilter](/reference/display_filter.md) or [Custom DisplayFilter](/guides/register_custom_dashboard_filters_.md).
...
- `displayFilters`
  ...
  The filters that are shown to the user. One can use [Core DisplayFilter](/reference/display_filter.md) or [Custom DisplayFilter](../../guides/register_custom_dashboard_filters_.md).
