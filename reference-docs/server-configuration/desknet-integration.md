...
- You should know about the different Livingdocs configuration levels/methods, namely the [channel config](../channel-config/content_types.md) and the [content type config](../channel-config/content_types.md))
