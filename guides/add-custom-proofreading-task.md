# Add your custom proofreading task
...
On the server we need to configure a new metadata field `proofreading` (more about metadata fields you can read [here](../reference-docs/server-configuration/metadata.md))
